...
- **Поиск**: FTS5 (BM25) и sqlite-vec (KNN) работают независимо. Слияние через Relative Score Fusion с адаптивным alpha.
